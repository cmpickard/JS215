// Implement a function that checks whether an email address is valid. An
// email address has two parts: A "local part" and a "domain part." An @ sign
...
// name (e.g., gmail.com, yahoo.com.ph, or myCompanyName.com). The domain
// name contains a server name (sometimes called the mail server name) and
...
// programs. We are using greatly simplified criteria to let you concentrate
// on the fundamentals of JavaScript, and not on the specifics of email
// addresses.

// Examples
// Copy Code
// function console.log(isValidEmail(email) {
//   // ...
// }
